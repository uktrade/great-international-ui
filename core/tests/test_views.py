...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_scale_less_than_100_for_opportunity_search(
        mock_cms_response, rf):
...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_scale_between_100_and_499_for_opportunity_search(
        mock_cms_response, rf):
    page = {
        'title': 'test',
        'meta': {
    ...
    request = rf.get(
        '/international/content/opportunities/?scale=£100m+-+£499m'
    )
    request.LANGUAGE_CODE = 'en-gb'
    response = OpportunitySearchView.as_view()(
        request,
...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_scale_between_500_and_999_for_opportunity_search(
        mock_cms_response, rf):
    ...
    request = rf.get(
        '/international/content/opportunities/?scale=£500m+-+£999m'
    )
    request.LANGUAGE_CODE = 'en-gb'
    response = OpportunitySearchView.as_view()(
        request,
...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_scale_greater_than_1000_for_opportunity_search(
        mock_cms_response, rf):
...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_scale_value_unknown_for_opportunity_search(
        mock_cms_response, rf):
    ...
    request = rf.get(
        '/international/content/opportunities/?scale=Value+unknown'
    )
    request.LANGUAGE_CODE = 'en-gb'
    response = OpportunitySearchView.as_view()(
        request,
...
@patch('directory_cms_client.client.cms_api_client.lookup_by_path')
def test_gets_right_region_filter_for_opportunity_search(
        mock_cms_response, rf):
    ...
    request = rf.get(
        '/international/content/opportunities/?region=South+of+England'
    )
    request.LANGUAGE_CODE = 'en-gb'
    response = OpportunitySearchView.as_view()(
        request,

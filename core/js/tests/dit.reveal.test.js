...
describe('reveal', () => {
    ...
    it('sets up the components', () => {
        ...
        expect(document.getElementById("content").getAttribute('aria-expanded')).toEqual('false');
    });
    ...
    it('expands the linked content on click', () => {
        ...
        expect(document.getElementById("content2").getAttribute('aria-expanded')).toEqual('false');
    });
})

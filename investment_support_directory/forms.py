...
class ContactCompanyForm(GovNotifyEmailActionMixin, forms.Form):
    TERMS_CONDITIONS_LABEL = (
        ...
        '<li>the Department for Business and Trade (DBT) has reasonably '
        ...
        '<li>DBT is not endorsing the character, ability, goods or services '
        'of members of the directory</li>'
        '<li>there is no legal relationship between DBT and directory '
        'members</li>'
        '<li>DBT is not liable for any direct or indirect loss or damage that '

...
DEBUG_SET_ENV_VARS := \
	...
	export DIRECTORY_FORMS_API_BASE_URL=https://directory-forms-api-staging.london.cloudapps.digital; \
	...
	export FEATURE_HOW_TO_SET_UP_REDIRECT_ENABLED=True; \
	export FEATURE_INDUSTRIES_REDIRECT_ENABLED=True; \
